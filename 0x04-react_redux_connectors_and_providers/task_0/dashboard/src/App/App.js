...
// Create a function named mapStateToProps that takes the state as an argument and returns an object with the key isLoggedIn and the value of the isLoggedIn property of the state.
const mapStateToProps = (state) => {
	return {
		isLoggedIn: state.get('isLogged')
	}
}
